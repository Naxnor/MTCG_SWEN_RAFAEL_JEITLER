...
public class BattleService
{
    ...
    private void DebugPrintDeck(string deckName, IEnumerable<Card> deck)
    {
        ...
        {
            Console.WriteLine(
                $"ID: {card.Id}, Name: {card.Name}, Damage: {card.Damage}, Element: {card.Element}, Class: {card.Class}");
        }
    ...
    private float CalculateEffectiveDamage(Card attackingCard, Card defendingCard)
    {
        ...
        switch (attackingCard.Class)
        {
            ...
            case "Kraken":
                ...
                break;
            case "Vampire":
                if (defendingCard.Class == "Elf" || defendingCard.Class == "Dwarf" || defendingCard.Class == "Orc" ||
